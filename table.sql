...
CREATE TABLE `forum` (`id` mediumint(9) NOT NULL AUTO_INCREMENT, `post_title` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL, `post` text COLLATE utf8_unicode_ci NOT NULL, `block` int(11) NOT NULL, `posted` varchar(40) COLLATE utf8_unicode_ci NOT NULL, `ptime` datetime NOT NULL, PRIMARY KEY (`id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `member` ( `id` mediumint(9) NOT NULL AUTO_INCREMENT, `name` varchar(30) COLLATE utf8_unicode_ci NOT NULL, `password` varchar(255) COLLATE utf8_unicode_ci NOT NULL, `email` varchar(255) COLLATE utf8_unicode_ci NOT NULL, `web_site` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL, `avatar` varchar(255) COLLATE utf8_unicode_ci NOT NULL, `rekey` varchar(40) COLLATE utf8_unicode_ci NOT NULL, `level` varchar(6) COLLATE utf8_unicode_ci NOT NULL, `joined` datetime NOT NULL, `last_login` datetime NOT NULL, PRIMARY KEY (`id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
